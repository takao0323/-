...
def generate_feedback(profile, report):
    ...
    encouragement_messages = [
        ...
        # 少しの進歩を認めて褒める（61-70）
        "今日も報告してくれましたね。その継続が結果を生みます",
        "小さな前進を積み重ねている。それが大切です",
        "0.1kgでも、100gでも、変化は変化。確実に前進していますよ",
        "完璧な一日じゃなくても、報告したこと自体が成長です",
        "できなかったことより、できたことに目を向けましょう",
        "昨日のあなたより、少しでも成長していれば十分です",
        "記録を続けること、それ自体が成果につながります",
        "今日の小さな努力が、明日の自信に変わります",
        "一歩ずつで大丈夫。私は伴走者として、見守っています",
